...
class CarrinhoStout extends StatefulWidget {
  @override
  _CarrinhoStoutState createState() => _CarrinhoStoutState();
}

class _CarrinhoStoutState extends State<CarrinhoStout> {
  int _unidade = 0;
  double _valor = 13.50;
